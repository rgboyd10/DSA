...
public class OrderedLinkedList
{
	...
	public boolean add(Comparable obj)
	{
		...
		OrderedLinkedList.this.add(obj);
		return true;
	}
	...
	public boolean remove(Comparable obj)
	{
		...
		OrderedListNode pos = findPos(obj);
	 ...
	 private static class OrderedListNode
    {
    	...
    	public OrderedListNode(Comparable obj, OrderedListNode previousNode, OrderedListNode nextNode)
    	{
    		theobj = obj;
